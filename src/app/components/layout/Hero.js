        ...
        <section className="hero ">
            <div className="py-12">
                ...
                <div className="flex gap-4 text-sm ">
                    <button className="bg-primary uppercase flex gap-2 items-center text-white px-4 py-2 rounded-full">Order now  <Right/></button>
                    <button className="flex gap-2 py-2 text-gray-600 font-semibold">Learn now <Right/></button>
                </div>
            </div>
